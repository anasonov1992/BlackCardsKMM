...
import com.example.blackcardskmm.components.createDeck.CreateCardDeckStore
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Scaffold(
            ...
            topBar = {
                TopAppBar(
                    navigationIcon = {
                        IconButton(onClick = { component.onOutput(CreateCardDeckComponent.Output.NavigateBack) }) {
                            Icon(
            ...
            bottomBar = {
                    BottomAppBar {
                        ...
                        Button(
                            onClick = { (component::onEvent)(CreateCardDeckStore.Intent.CreateCardDeck) }
                        ) {
                            Text(
                                text = "СОЗДАТЬ КОЛОДУ",
                                fontFamily = mikadanFont
