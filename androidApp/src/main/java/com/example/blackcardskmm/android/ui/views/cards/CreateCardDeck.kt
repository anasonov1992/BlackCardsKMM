...
import com.example.blackcardskmm.android.ui.vm.CreateCardDeckViewModel
...
@Destination(
    navArgsDelegate = CreateCardDeckArgs::class
)
@Composable
fun CreateCardDeck(
    ...
    val isLoading by viewModel.loadingStatus.collectAsStateWithLifecycle(false)
    ...
    viewModel.uiEvent.safeCollector(
        ...
        onSuccessCallback = {
            coroutineScope.launch {
                scaffoldState.snackbarHostState.showSnackbar("Колода успешно создана!")
            }
