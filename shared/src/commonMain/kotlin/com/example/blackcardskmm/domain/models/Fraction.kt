...
data class Fraction(
    ...
    constructor(fraction: FractionDto) : this(fraction.id, fraction.type, fraction.name, fraction.description, fraction.artUrl, fraction.logoUrl)

    constructor(fraction: FractionShortDto) : this(fraction.id, fraction.type, fraction.name, logoUrl = fraction.logoUrl)
}
